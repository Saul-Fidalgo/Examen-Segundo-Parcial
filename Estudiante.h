...
public:
	...
	Estudiante(string nom, string ape, string dir, int gen, string car, int tel, string fcna, string em) : Persona(nom, ape, dir, tel, gen, fcna) {
		email = em;
		carnet = car;
	...
	void setFehca_Nacimiento(string fn) { fecha_nacimiento = fcna; }
	...
	void crear_estudiante() {
		...
		if (cn.getConectar()) {
			string insert = "insert into universidad.Estudiante(id_estudiante,carnet,nombres,apellidos,direccion,telefono,genero,email,fecha_nacimiento) values(" + id_estudiante + "','" + carnet + "','" + nombres + "', '" + apellidos + "','" + direccion + "','" + t + "'," + g + ", '" + email + "','" + fecha_nacimiento + "')";
	...
	void actualizar_estudiante() {
		...
		cin >> fecha_nacimiento;
		if (cn.getConectar()) {
			string update = "update universidad.Estudiente set id_estudiante =('" + id_estudiante + "'), carnet =('" + carnet + "'), nombre =('" + nombres + "'), apellido =('" + apellidos + "'), direccion=('" + direccion + "'), genero=(" + g + "), email=('" + email + "'), telefono=('" + t + "'), fecha_nacimiento('" + fecha_nacimiento + "') where id_estudiente = ('" + id_estudiante + "')  ";
